...
VALUES(ORDER_NO_SEQ.NEXTVAL, SYSDATE, ‘서울시 강동구’, 0, ‘CHOI’); 
...
INSERT INTO ORDER_DETAIL
(ORDER_DETAIL_NO, LIQOUR_NO, ORDER_NO, COUNT, ORDER_PRICE)
VALUES(ORDER_DETAIL_NO_SEQ.NEXTVAL, ‘X01’, 1, 2, 0);

INSERT INTO ORDER_DETAIL
(ORDER_DETAIL_NO, LIQOUR_NO, ORDER_NO, COUNT, ORDER_PRICE)
VALUES(ORDER_DETAIL_NO_SEQ.NEXTVAL, ‘X01’, 2, 2, 0);

INSERT INTO ORDER_DETAIL
(ORDER_DETAIL_NO, LIQOUR_NO, ORDER_NO, COUNT, ORDER_PRICE)
VALUES(ORDER_DETAIL_NO_SEQ.NEXTVAL, ‘X01’, 3, 2, 0);
